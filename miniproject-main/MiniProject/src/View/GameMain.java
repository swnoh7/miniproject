...
public class GameMain {
	...
	public static void main(String[] args) {
		...
		String comPath = "C:\\Users\\smhrd\\Desktop\\miniproject-main\\miniproject-main\\MiniProject\\BGM\\";
		...
		musiclist.add(new mp3(comPath + "가즈아.mp3"));// 19
		...
		while (true) {
			...
			if (input == 1) { // 회원가입
				...
				if (userDto != null) {
					...
					mp3_2.play(musiclist.get(12).getPath()); // 계속 깔려있을 노래
					ConsoleClear();
	...
	public static void manMixAll(int hp, int fullness, int love) {
        hp = manMixhp(hp);
        fullness = manMixfullness(fullness);
        love = manMixlove(love);
    }
